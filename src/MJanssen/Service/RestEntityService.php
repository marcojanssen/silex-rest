...
class RestEntityService
{
    ...
    public function getAction($identifier)
    {
        ...
        return new JsonResponse(
            $this->app['doctrine.extractor']->extractEntity(
                $entity,
                'detail'
            )
        );
    ...
    public function getCollectionAction()
    {
        ...
        return new JsonResponse(
            $this->app['doctrine.extractor']->extractEntities(
                $repository->findBy(
                    array(),
                    array('id' => 'ASC')
                ),
     ...
     * @return mixed
     */
    protected function getEntityFromRepository($id, $field = 'id')
    {
        $repository = $this->getEntityRepository();
     ...
     * @param $id
     */
    protected function isValidEntity($entity, $id)
    {
        if(null === $entity) {
     ...
     */
    protected function setFiltersForRepositoryByRequest(FilterableRepositoryInterface $repository)
    {
